...
- (void)setPhotos:(NSArray *)photos
{
    ...
    _saveImageBtn.frame = CGRectMake(20, 0, 40, 30);
...
- (void)image:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo
{
    ...
    //    [MBProgressHUD showSuccess:@"成功保存到相册" toView:nil];
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"保存成功！" message:@"已经保存到本地相册" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
